...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__26580 = c;
var G__26580__$1 = (((G__26580 == null))?null:G__26580.prototype);
if((G__26580__$1 == null)){
return null;
} else {
return G__26580__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__26680__delegate = function (args){
...
return G__26680__delegate.call(this,args);};
...
return G__26680__delegate(args);
});
...
var G__26592 = c;
var G__26592__$1 = (((G__26592 == null))?null:G__26592.constructor);
if((G__26592__$1 == null)){
return null;
} else {
return G__26592__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__26596 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__26597 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__26597);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__26596);
}});
...
var c = this;
var G__26602_26688 = goog.object.get(c,"cljsRatom");
if((G__26602_26688 == null)){
} else {
reagent.ratom.dispose_BANG_(G__26602_26688);
}
...
var renders_26690 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_26691 = cljs.core.first(cljs.core.vals(renders_26690));
...
if((cljs.core.count(renders_26690) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_26690))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_26691)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_26691], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__26660 = o;
goog.object.set(G__26660,cljs.core.name(k),v);
...
return (function() { 
var G__26693__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
...
while (G__26694__i < G__26694__a.length) {G__26694__a[G__26694__i] = arguments[G__26694__i + 0]; ++G__26694__i;}
  args = new cljs.core.IndexedSeq(G__26694__a,0,null);
} 
return G__26693__delegate.call(this,args);};
...
return G__26693__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__26672 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__26673 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__26673);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__26672);
}});
...
var vec__26674 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26674,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26674,(1),null);
...
var G__26677 = goog.object.get(reagent_state,"cljsRatom");
if((G__26677 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__26677);
}
});
}),[]);
