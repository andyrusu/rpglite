...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_30680 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_30680(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30681 = (function (port,val,fn1_handler){
var x__4509__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30681(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_30688 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_30688(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_30690 = (function (chan){
var x__4509__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_30690(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_30691 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_30691(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_30695 = (function (h){
var x__4509__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_30695(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_30698 = (function (h){
var x__4509__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_30698(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_30703 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_30703(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_30707 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_30707(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_30710 = (function (b,itm){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_30710(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_30712 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_30712(b);
}
});
