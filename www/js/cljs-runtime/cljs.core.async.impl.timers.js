...
while(true){
if((i <= self__.level)){
var links_33118 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_33118[i]));
} else {
x__$2.forward.push((((i < links_33118.length))?(links_33118[i]):null));
}

if((i < links_33118.length)){
(links_33118[i] = x__$2);
} else {
links_33118.push(x__$2);
}
...
var i_33124 = (0);
while(true){
if((i_33124 <= self__.level)){
var links_33125 = (update[i_33124]).forward;
if((x__$1 === (((i_33124 < links_33125.length))?(links_33125[i_33124]):null))){
(links_33125[i_33124] = (x__$1.forward[i_33124]));

var G__33126 = (i_33124 + (1));
i_33124 = G__33126;
continue;
} else {
var G__33127 = (i_33124 + (1));
i_33124 = G__33127;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__33152 = nx;
var G__33153 = (level__$1 - (1));
x = G__33152;
level__$1 = G__33153;
continue;
} else {
var G__33154 = x;
var G__33155 = (level__$1 - (1));
x = G__33154;
level__$1 = G__33155;
continue;
}
